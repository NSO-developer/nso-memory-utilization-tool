...
plot "data/mem_total.log" using 1:5 with lines axes x1y1 lc 'red' lw 2 title "CommitLimit", \
     ...
     "data/mem_ncs.smp.log" using 1:2 with lines axes x1y1 title "ncs.smp", \
     "data/mem_total.log" using 1:2 with lines axes x1y1 title "PythonVM(Total)", \
     "data/mem_NcsJVMLauncher.log" using 1:2 with lines axes x1y1 title "JavaVM"
